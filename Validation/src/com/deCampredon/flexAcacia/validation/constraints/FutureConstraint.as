...
package com.deCampredon.flexAcacia.validation.constraints
{
	...
	[Metadata(name="Future",types="property", multiple="true")]
	/**
	 * the FutureConstraint allow you to validate that a date
	 * property is in the future
	 * 
	 * @author François de Campredon
	 */
	public class FutureConstraint extends AbstractConstraint
	{
		 ...
		 * Constructor
		 */
		public function FutureConstraint()
		{
			super();
		}
		 ...
		 */
		public var errorMessageKey:String = "tooEarlyError";
		...
		{
			var value:Date = new Date((PropertyUtil.getFieldValue(target,field) as Date).time);
			if(value) {
